    ...
    return {
        ...
        "dim_category": {
            ...
            "columns": {
                ...
                "category_name": {
                    "description": "类目名称，例如美妆护肤、面部护肤、手机通讯。",
                    "aliases": ["类目名称", "品类名称", "类目", "品类"],
                    "semantic_role": "dimension",
        ...
        "dim_product": {
            ...
            "columns": {
                ...
                "list_price": {
                    ...
                    "keyword_text": "list_price 标价 商品单价 挂牌价 原价 售价 单价 价格 商品表",
    ...
    return {
        ...
        "fact_order": {
            ...
            "columns": {
                ...
                "channel": {
                    "description": "下单渠道，取值为 APP、小程序、PC官网、直播间。",
                    "aliases": ["下单渠道", "订单渠道", "交易渠道"],
                    "semantic_role": "dimension",
        ...
        "fact_order_item": {
            ...
            "columns": {
                ...
                "quantity": {
                    "description": "该商品的购买数量。",
                    "aliases": ["购买数量", "数量", "件数", "销量"],
                    "semantic_role": "metric",
                    "business_usage": "统计商品销量时求和这个字段。",
                    "keyword_text": "quantity 购买数量 数量 件数 销量 卖了多少件 订单明细表",
                },
                "item_price": {
        ...
        "fact_user_behavior": {
            ...
            "columns": {
                ...
                "behavior_type": {
                    ...
                    "keyword_text": "behavior_type 行为类型 操作类型 事件类型 浏览 加购 收藏 加入购物车 漏斗",
                },
                "behavior_time": {
                    "description": "行为发生时间。",
